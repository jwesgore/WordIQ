...
@Model
class FrenzySaveModel: BaseSaveModel {
    ...
    init(bestGameScore: Int, totalGamesPlayed: Int = 0, totalTimePlayed: Int = 0, totalXP: Int = 0, totalValidGuesses: Int = 0, totalInvalidGuesses: Int = 0, totalEasyDiff: Int = 0, totalMediumDiff: Int = 0, totalHardDiff: Int = 0) {
        // MARK: Standard Game Values
